    ...
    <div class="container">
        <div class="main-content">
            ...
            <div class="main-content-paragraph">
                <span
                    style="font-family: 'Finlandica', sans-serif; font-size: 20px; font-weight: 700; color: #000000;">The
                    KPI Dictionary - Volume 1</span>
                is a reference collection of Key Performance Indicators, used in practice
                today, which
                covers the major functional areas
                of an organization, regardless of its industry specifics. The collection contains the most relevant
                means for measuring
                performance, throughout the most
                common departments in either public, private or non-profit organizations, such as: Finance, Sales, Human
                Resources,
                Marketing and IT.
            </div>
                    ...
                    <div class="main-content-download-containrt-left-description">
                        <div>
                            <div class="main-content-download-containrt-left-description-item">
                                <p>
                                    <span> SELECT </span>
                                    -the critical KPIs to drive operational
                                    success
                                </p>
            ...
            <div>
                ...
                <div>
                    <h2>
                        CHAT WITH US </h2>
                    <p>
                        Have questions? A customer service
                        representative is online to help you via
                        Live Chat. Join in the conversation.
                    </p>
                </div>
            </div>
            <div>
